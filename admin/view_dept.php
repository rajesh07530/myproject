...
<td><?=strtoupper($subject['dept_name'])?></td>
<td>
<a href="edit_dept.php?dept_id=<?=$subject['dept_id']?>&dept_name=<?=$subject['dept_name']?>" class="btn btn-primary">Edit</a>
<a href="deptOperation.php?action=deptdelete&dept_id=<?=$subject['dept_id']?>" class="btn btn-primary">Delete</a>
</td>
</tr>
<?php
}
...
<tr>
	<td></td>
<td>
<h4><b>No Departments Available</b></h4>
</td>
	<td></td>
</tr>
<?php
