...
<form role="form" action="deptOperation.php" method="post" enctype="multipart/form-data">
<div class="box-body">
<div class="form-group">
<label>Department ID</label>
<input type="text" class="form-control" name="dept_id" value="<?=$_REQUEST['dept_id'];?>"readonly required/>
<label>Department Name</label>
<input type="text" class="form-control" name="dept_name" value="<?=strtoupper($_REQUEST['dept_name']);?>" required/>

</div>
<button type="submit" name="action" value="update_dept" class="btn btn-primary">Update</button>
</div>
</div>
</div>
</div>
