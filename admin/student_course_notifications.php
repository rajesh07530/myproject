...
<h1></i>
Student Course Notitfication
<small></small>
</h1>
<ol class="breadcrumb">
<li><a href="#"></i>Student Course Notitfications</a></li>
</ol>
</section>
...
<h1 class="box-title">
<a></i><b>Course Unavailable/Limited Notifications</b></a>
</h1>
</div>	
<div class="box-body">
...
<tbody>
<?php
$sql="select cn.id,cn.option_type,cn.status,cn.content,st.student_name,st.emailid from course_notifications cn, student st where cn.student_id=st.student_id";
$res=mysql_query($sql);
...
<form method="post" action="course_notifi_RequestSends.php" >
	<input type="hidden" name="id" value="<?=$rs['id'] ?>">
	<input type="hidden" name="stdName" value="<?=$rs['student_name'] ?>">
...
<input type="hidden" name="id" value="<?=$rs['id'] ?>">
<button type="submit" name="action" value="CourseReq" class="btn btn-primary">Delete</button>
</form>
