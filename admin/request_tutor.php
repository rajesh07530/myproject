...
<h1 class="box-title">
<a></i><b>New Tutors Request List</b></a>
</h1>
</div>	
<div class="box-body">
...
<td><?=$rs['phone_number']?></td>
	<td>
		...
		<?php
		$su=$rs['subject'];
		$sql3="select s.subject_name from subject s where s.subject_id in($su) order by s.subject_name";
	
	$res3=mysql_query($sql3);
$sub3=array();
while($rs3=mysql_fetch_assoc($res3)){
array_push($sub3,$rs3['subject_name']);
}
	echo implode(',',$sub3);
?>
	</td>
...
<td></td>
<td>
<h4><b>No New Tutor Request Available</b></h4>
</td>
<td></td>
<td></td>
</tr>
