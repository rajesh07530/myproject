...
<?php
						if(isset($_SESSION['flag'])){
							if($_SESSION['flag']=='success'){
								...
								echo 'Sorry we are unable to delete your schedule';
							}
						}
					?>
					</h3>
...
<td>
<a href="deleteCourseNotification.php?action=Subdelete&id=<?=$re['id']?>" class="btn btn-primary">Delete</a>
</td>
</tr>
<?php
