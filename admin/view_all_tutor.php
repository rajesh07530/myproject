...
while($rs=mysql_fetch_assoc($res)){
	...
	<td>
	<a href="tutor_moreDtailes.php?tutor_id=<?=$rs['tutor_id']?>" class="btn btn-primary">View More</a>
	<a href="tutor_search.php?tutor_id=<?=$rs['tutor_id']?>" class="btn btn-primary">View schedule</a>
	</td>	
	</tr>
<?php	
	}
...
<td></td>
<td>
<h4><b>No Tutor details Available</b></h4>
</td>
<td></td>
<td></td>
</tr>
